        ...
        $.ajax({
            ...
            error: function (xhr, status, error) {
                ...
                try {
                    ...
                    showNotification($managePilotsAlertContainer, 'danger', errorResponse.message || "Server error occurred.");
                } catch (e) {
                    showNotification($managePilotsAlertContainer, 'danger', `Network error (${xhr.status}). Please try again.`);
                }
                $button.prop('disabled', false).html(originalButtonContent);
            }
        });
