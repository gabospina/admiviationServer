...
// // CSRF Token Strategy: Per-Session (one token per user session)
if (!isset($_SESSION['csrf_token'])) {
    $_SESSION['csrf_token'] = bin2hex(random_bytes(32));
}

// ======================================================================
// === DIAGNOSTIC LOGGING: Record the token at the moment of creation ===
error_log("HEADER.PHP >>> Session ID: [" . session_id() . "] --- CSRF Token Set: [" . $_SESSION['csrf_token'] . "]");
// ======================================================================
...
<body>
    ...
    <!-- ========================================================= -->
    <input type="hidden" name="form_token" id="form_token_manager" value="<?php echo htmlspecialchars($_SESSION['csrf_token'] ?? ''); ?>">
