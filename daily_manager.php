...
<style>
    /* Today's assignments - more prominent */
    .today-assignment {
    ...
    /* Tomorrow's assignments - subtle styling */
    .tomorrow-assignment {
        background-color: #f8f9fa !important;
    }

    .tomorrow-assignment:hover {
    ...
    /* FIXED: Make tabs visible and reduce blank space */
    /* .tab-pane[data-tab="queue"] {
        position: relative;
        padding-top: 5px; 
    } */

    /* .tab-pane[data-tab="queue"] .page-header {
        background: white;
        padding: 10px 15px;
        margin: 5px 0 10px 0;
        border-radius: 4px;
    ...
    /* .tab-pane[data-tab="queue"] .text-center.text-muted {
        background: #f8f9fa;
        padding: 8px 15px; 
        margin: 0 0 10px 0; 
        border-radius: 4px;
    ...
    /* .tab-pane[data-tab="queue"] .row[style*="margin-bottom: 15px;"] {
        margin-top: 0;
    ...
    /* .tab-pane[data-tab="queue"] .table-responsive {
        margin-top: 0;
        position: relative;
        z-index: 1;
        border: 1px solid #dee2e6;
    ...
    .tab-pane[data-tab="queue"] #messageQueueTable {
        margin-bottom: 0;
    }

    .tab-pane[data-tab="queue"] #messageQueueTable thead th {
        background: #f8f9fa;
    ...
    /* CRITICAL FIX: Ensure tabs container is visible and properly positioned */
    .nav-tabs {
        margin-bottom: 10px !important; /* Reduced space below tabs */
        position: relative;
    ...
    .nav-tabs > li {
        margin-bottom: -1px; /* Align tabs properly */
    }
    ...
    .tab-pane[data-tab="queue"] #messageQueueTable td {
        padding: 8px; /* Reduced padding */
    }

    /* Reduce space in the button row */
    .tab-pane[data-tab="queue"] .row .col-md-2 {
...
<style>
    /* Fix overlay issues for both Queue and History tabs */
    
    /* Queue Tab (Notification Control Panel) */
    .tab-pane[data-tab="queue"] .page-header {
    ...
    /* History Tab (Notification Sending History) */
    .tab-pane[data-tab="history"] .page-header {
        margin-bottom: 8px !important;
        padding: 8px 12px !important;
        background: white;
        border-radius: 4px;
    ...
    .tab-pane[data-tab="history"] .row[style*="margin-bottom: 15px;"] {
        margin-bottom: 8px !important;
        background: white;
        padding: 10px;
        border-radius: 4px;
    ...
    .tab-pane[data-tab="history"] .table-responsive {
        margin-top: 0;
        border: 1px solid #dee2e6;
        border-radius: 4px;
        background: white;
    ...
    /* Make buttons more compact in both tabs */
    #sendPreparedNotiBtn, #deleteHistoryBtn, #refreshHistoryBtn {
        padding: 6px 12px !important;
        font-size: 13px !important;
    }

    /* Reduce table spacing in both tabs */
    .tab-pane[data-tab="queue"] #messageQueueTable thead th,
    .tab-pane[data-tab="history"] #historyLogTable thead th {
        padding: 8px 6px !important;
    }

    .tab-pane[data-tab="queue"] #messageQueueTable td,
    .tab-pane[data-tab="history"] #historyLogTable td {
        padding: 6px !important;
    }

    /* Make form controls more compact */
    .routing-input, #history_date_filter, #history_search_filter {
        padding: 4px 8px !important;
        font-size: 13px !important;
        height: 30px !important;
    }

    /* Ensure proper spacing for filter rows in history tab */
    .tab-pane[data-tab="history"] .row .col-md-2,
    .tab-pane[data-tab="history"] .row .col-md-3,
    .tab-pane[data-tab="history"] .row .col-md-4 {
        margin-bottom: 5px;
    }

    /* Labels in history tab */
    .tab-pane[data-tab="history"] .lbl {
        font-size: 12px !important;
              ...
              <div class="tab-container">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" data-tab="schedule">
                        ...
                        <!-- ============================================ -->
                        <!-- === END: Weekly Schedule  Selections   === -->
                        <!-- ============================================ -->
                            ...
                            <table class="table table-bordered table-striped no-shadow" id="messageQueueTable">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width: 8%;">Craft</th>
                                        <th style="width: 14%;">Pilot Name</th>
                                        <th style="width: 5%;">Position</th>
                                        <th style="width: 35%;">Routing</th>
                                        <th style="width: 12%;">Recipient Phone</th>
                                        <!-- "Action" column is now "Status" -->
                                        <th style="width: 7%;" title="Status of the notification">Status</th> 
                                    </tr>
                                </thead>
