...
// We can define the base path right here for this standalone page.
define('BASE_PATH', '/');
...
<head>
    ...
    <title>AdmiViation - Aviation Operations Management Platform</title>
    <meta name="keywords"
        content="aviation management software, flight operations, crew scheduling, pilot management, fleet management, aviation compliance, charter operations, business aviation, flight scheduling software, cloud, web application,helicopters,helicopter,offshore, helicopters offshore, helicopter offshore, offshore helicopters,scheduling,flying, flight,schedule,pilots,statistics,log book,log,Angola,management,pilot,planner,easy,simple,software,cloud,web application, application">
    <meta name="description"
        content="AdmiViation is the all-in-one cloud platform for aviation operators to streamline scheduling, manage crew, ensure compliance, and optimize fleet operations, Helicopters Offshore offers a way to easily manage schedules, training, tests expiration, keeping a logbook, and keeping in touch within your community.">

    <!-- FAVICONS -->
    <link rel="icon" href="<?php echo BASE_PATH; ?>images/favicons/favicon.ico">

    <!-- CSS (with corrected root-relative paths) -->
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Montserrat:400,700">
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Open+Sans:300italic,400italic,600italic,700italic,800italic,400,300,600,700,800">
    <link rel="stylesheet" href="<?php echo BASE_PATH; ?>css/bootstrap.min.css" type="text/css">
    <link rel="stylesheet" href="<?php echo BASE_PATH; ?>css/font-awesome.min.css" type="text/css">
    <link rel="stylesheet" href="<?php echo BASE_PATH; ?>css/animate.min.css" type="text/css">
    <link rel="stylesheet" href="<?php echo BASE_PATH; ?>css/style.css" type="text/css">
    <link id="color-css" rel="stylesheet" href="<?php echo BASE_PATH; ?>css/colors/orange.css" type="text/css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/noty/3.1.4/noty.min.css">

	<!-- ====================================================================== -->
    <!-- === THIS IS THE FIX: DEFINE BASE URL FOR JAVASCRIPT === -->
    <script>var base_url = '<?php echo BASE_PATH; ?>';</script>
    <!-- ====================================================================== -->
...
<body class="enable-animations enable-preloader">
    <div id="document" class="document">
            ...
            <div class="container-fluid">
                ...
                <nav id="navigation" class="navigation navbar-collapse collapse navbar-right">
                    <ul id="header-nav" class="nav navbar-nav">
                        ...
                        <!-- Ensure data-target points to the correct modal IDs -->
                        <li class="header-action-button">
                            <a href="#" class="btn btn-primary" data-toggle="modal" data-target="#signupModal">Sign Up</a>
                        </li>
                        <li class="header-action-button">
                            <a href="#" class="btn btn-primary" data-target="#loginModal">Log In</a>
                        </li>
                    </ul>
                </nav>
            </div>
        ...
        <section id="hero" class="hero-section hero-layout-simple hero-fullscreen section section-dark">
            <div class="section-background">
                ...
                <div class="section-background-image parallax" data-stellar-ratio="0.4">
                    <img src="images/backgrounds/head_banner.jpg" alt="AdmiViation dashboard" style="opacity: 0.3;">
                </div>
            </div>
                        ...
                        <div class="row">
                            <div class="col-md-10 col-md-offset-1">
                                ...
                                <div class="hero-heading">
                                    <h1 class="hero-title">Aviation Management</h1>
                                    <p class="hero-tagline">The all-in-one platform for crew scheduling, fleet management, and operational compliance.</p>
                                </div>
                ...
                <div class="row">
                    <div class="col-md-10 col-md-offset-1">
                        <p class="headline-text">
                            Designed by aviation professionals. <strong>AdmiViation</strong> simplifies complex workflows, centralizes records, and enhances team coordination, saving you valuable time and resources.
                        </p>
                    </div>
                </div>
            </div>
        ...
        <section id="about" class="about-section section">
            <div class="container">
                <h2 class="section-heading text-center">About AdmiViation</h2>
                <div class="about-row row">
                    <!-- <div class="about-image col-md-6" data-animation="fadeIn"> -->
                    <div class="about-image col-md-6">
                        <img src="images/backgrounds/about_us_2.jpg" alt="AdmiViation fleet"
                            style="border-radius: 15px;">
                    </div>
                    <div class="about-text col-md-6">
                        <p class="lead">Our mission is to simplify your operations.</p>
                        <p>At <strong>AdmiViation</strong>, we believe powerful software should be intuitive. We built a comprehensive platform to manage the critical aspects of your aviation business, because we understand the challenges you face. Key benefits include:</p>
                        <ul class="icon-list">
                            <li><span class="icon-list-icon fa fa-calendar"></span>
                                <h4 class="icon-list-title">Unified Scheduling</h4>
                                <p>Effortlessly manage flight schedules, training events, and duty rosters in a single, intuitive interface.</p>
                            </li>
                            <li><span class="icon-list-icon fa fa-users"></span>
                                <h4 class="icon-list-title">Seamless Communication</h4>
                                <p>Keep your entire team connected with integrated messaging and notifications, ensuring everyone is on the same page.</p>
                            </li>
                            <li><span class="icon-list-icon fa fa-clock-o"></span>
                                <h4 class="icon-list-title">Centralized Data</h4>
                                <p>Consolidate all critical data—from pilot certifications to aircraft logs—in one secure, accessible location.</p>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <section id="benefits" class="benefits-section section-gray section">
            <div class="container">
                <h2 class="section-heading text-center">Powerful Features for Modern Operators</h2>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="benefit">
                                ...
                                <p class="benefit-description">Adding a pilot to your fleet is just a few keys and a
                                    click away. You can keep track certifications, manage contact information, and assign qualifications for specific aircraft, and
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="benefit">
                                ...
                                <p class="benefit-description">Drastically reduce planning time. Our smart scheduling tools flag compliance issues like flight time limitations and expired certifications, preventing costly errors.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="benefit">
                                ...
                                <p class="benefit-description">Beyond flights, our platform includes robust scheduling for training sessions. Organize trainers, examiners, and trainees all in one centralized calendar.</p>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="benefit">
                                ...
                                <h4 class="benefit-title">Compliance Tracking and Paperwork</h4>
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="benefit">
                                ...
                                <h4 class="benefit-title">Fleet & Contract Management</h4>
                                <p class="benefit-description">Maintain a comprehensive database of your aircraft and client contracts. Simply add a new asset or contract and begin scheduling against it immediately.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-6 col-md-offset-2">
                            <div class="benefit">
                                ...
                                <h4 class="benefit-title">Document Hub</h4>
                                <p class="benefit-description">Upload and distribute important documents to your entire fleet. The system tracks who has viewed each document, ensuring accountability.</p>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="benefit">
                                ...
                                <h4 class="benefit-title">Role-Based Permissions</h4>
                                <p class="benefit-description">Control what each user can see and do. Assign different permission levels to pilots, dispatchers, and administrators to ensure data security and integrity.</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="hiw-row row">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="hiw-item"><img class="hiw-item-picture" src="images/backgrounds/addpilot.png"
                            ...
                            <div class="hiw-item-text"><span class="hiw-item-icon">1</span>
                                <h4 class="hiw-item-title">Onboard Your Crew & Fleet</h4>
                                <p class="hiw-item-description">Quickly add your pilots and aircraft. Set their qualifications, assign contracts, and define roles and permissions, and that's it!
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="hiw-item even"><img class="hiw-item-picture"
                                src="images/backgrounds/how_it_works_banner_2.jpg" alt="AdmiViation flying">
                            <div class="hiw-item-text"><span class="hiw-item-icon">4</span>
                                <h4 class="hiw-item-title">Relax & Fly!</h4>
                                <p class="hiw-item-description">We take care of all the heavy lifting, giving you the clarity and peace of mind to focus on your core business. It really can be that easy.</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section id="numbers" class="numbers-section section-dark section">
            ...
            <div class="section-background">
                <!-- IMAGE BACKGROUND -->
                <div class="section-background-image parallax" data-stellar-ratio="0.4">
                    <img src="images/backgrounds/numbers_banner_2.jpg" alt="Aviation statistics"
                        style="opacity: 0.2;">
                </div>
            </div>
        ...
        <section id="future" class="future-section section-gray section">
            <div class="container">
                <div class="row">
                    <div class="col-md-10 col-md-offset-1">
                        <p class="headline-text">We are continuously expanding our platform to deliver everything your operation needs, all in one place.</p>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container-fluid two-cols-description-row">
                ...
                <div class="two-cols-description-text">
                    ...
                    <div class="two-cols-description-text-inner">
                        ...
                        <h2 class="section-heading text-left">Integrated Communication</h2>
                        <p>Keep your team synchronized with powerful, built-in communication tools.</p>

                        <ul class="nice-list">
                            <!-- <li><strong>News Feed</strong> <small>NEW</small>. Find out all the important updates around
                                the world that apply to pilots.</li> -->
                            <li><strong>Direct & Group Messaging</strong> <small>NEW</small>. Send private or group messages directly within the platform. Ideal for quick operational updates and coordination.</li>
                ...
                <div class="two-cols-description-image">
                    <img src="images/backgrounds/community_image_2.jpg" alt="Aviation team communication">
                </div>
            ...
            <div class="container">
                ...
                <div class="row text-center">
                    <div class="col-md-10 col-md-offset-1 col-sm-12">
                        ...
                        <p class="text-nowrap">AdmiViation is currently in an active development and beta phase. We invite you to try the platform for free and see how we can customize it to fit your operational needs.</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section id="closing" class="closing-section section-dark section">
            <div class="section-background">
                <div class="section-background-image parallax" data-stellar-ratio="0.4">
                    <img src="images/backgrounds/11.jpg" alt="offshore AdmiViation view" style="opacity: 0.15;">
                </div>
            </div>
            <div class="container">
            ...
            <div class="container-fluid maps-row">
                ...
                <div class="maps-text">
                    ...
                    <div class="maps-text-inner">
                        ...
                        <p>To see how AdmiViation can be tailored to your fleet and scheduling requirements, send us a message. We'd love to hear from you and get you on board.</p>
                        ...
                        <form id="publicContactForm">
				            ...
				            <div class="row">
				                ...
				                <div class="form-group">
				                    ...
				                    <input type="email" class="form-control" name="msg-email" id="msg-email" required>
				                </div>
				                <div class="form-group">
				                    <textarea cols="54" rows="8" class="form-control" placeholder="Message" id="msg-content" required></textarea>
				                </div>
				                <div class="form-group">
				                    <!-- Change to type="button" to let JS handle it -->
				                    <button type="button" class="btn btn-primary form-control" id="sendMessage">Send Message</button>
				                </div>
				            </div>
				        </form>
                    </div>
        ...
        <section id="footer" class="footer-section section">
            <div class="container">
                <p class="footer-logo">AdmiViation</p>
                <div class="footer-socmed">
                    <a href="https://www.facebook.com/AdmiViation" target="_blank"><span
                            class="fa fa-facebook"></span></a>
                    <a href="https://twitter.com/AdmiViation" target="_blank"><span class="fa fa-twitter"></span></a>
                    <a href="https://plus.google.com/+AdmiViation/about" target="_blank"><span
                            class="fa fa-google-plus"></span></a>
                </div>
                <div class="footer-copyright">
                    © <?php echo date("Y"); ?> Evoltrex Canada Inc.
                </div>
            </div>
        </section>
        ...
        <!-- ================================= -->
         ...
         <!-- include 'login_loginModal.php'; ?> -->
         <!-- include 'login_signupModal.php'; ?> -->

        <?php include(__DIR__ . '/login_loginModal.php'); ?>
		<?php include(__DIR__ . '/login_signupModal.php'); ?>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p class="text-center">By using AdmiViation.com you are agreeing to the following:</p>
                        ...
                        <ol type="a">
                            <li>
                                ...
                                (information or software) on AdmiViation's web site for personal,
                                ...
                                <ol type="i">
                                    ...
                                    <li>attempt to decompile or reverse engineer any software contained on AdmiViation's web site;</li>
                            ...
                            <li>
                                ...
                                may
                                be terminated by AdmiViation at any time. Upon terminating your viewing of
                                these
                        ...
                        <ol type="a">
                            <li>
                                The materials on AdmiViation's web site are provided "as is". AdmiViation
                                makes no warranties, expressed or implied, and hereby disclaims and negates all other
                                warranties, including without limitation, implied warranties or conditions of
                                merchantability, fitness for a particular purpose, or non-infringement of intellectual
                                property or other violation of rights. Further, AdmiViation does not warrant or
                        ...
                        <p>
                            In no event shall AdmiViation or its suppliers be liable for any damages
                            (including,
                            without limitation, damages for loss of data or profit, or due to business interruption,)
                            arising out of the use or inability to use the materials on AdmiViation's Internet
                            site, even if AdmiViation or a AdmiViation authorized representative has
                            been
                        ...
                        <p>
                            The materials appearing on AdmiViation's web site could include technical,
                            typographical, or photographic errors. AdmiViation does not warrant that any of the
                            materials on its web site are accurate, complete, or current. AdmiViation may make
                            changes to the materials contained on its web site at any time without notice. AdmiViation does not, however, make any commitment to update the materials.
                        </p>
                        ...
                        <p>
                           AdmiViation has not reviewed all of the sites linked to its Internet web site and
                            is
                            not responsible for the contents of any such linked site. The inclusion of any link does not
                            imply endorsement by AdmiViation of the site. Use of any such linked web site is at
                            the
                            user's own risk.
                        </p>
                        ...
                        <p>
                            AdmiViation may revise these terms of use for its web site at any time without
                            notice.
                        ...
                        <p>
                            Any claim relating to AdmiViation's web site shall be governed by the laws of the
                            State
    ...
    <!-- JAVASCRIPT (with corrected root-relative paths) -->
    
    <script src="<?php echo BASE_PATH; ?>js/jquery-3.7.1.min.js"></script>
    <script src="<?php echo BASE_PATH; ?>js/jquery-migrate-3.5.2.min.js"></script>
    <script src="<?php echo BASE_PATH; ?>js/bootstrap.min.js"></script>
    <script src="<?php echo BASE_PATH; ?>js/respimage.min.js"></script>
    <script src="<?php echo BASE_PATH; ?>js/jpreloader.min.js"></script>
    <script src="<?php echo BASE_PATH; ?>js/jquery.counterup.min.js"></script>
    <script src="<?php echo BASE_PATH; ?>js/jquery.stellar.min.js"></script>
    <script src="<?php echo BASE_PATH; ?>js/script.js"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/noty/3.1.4/noty.min.js"></script>
    <script src="<?php echo BASE_PATH; ?>loginfunctions.js"></script>
	<script src="<?php echo BASE_PATH; ?>feedback-form.js?v=1.1"></script>
</body>
</html>
