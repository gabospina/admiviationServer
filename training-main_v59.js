...
jQuery(function ($) {
    ...
    function setupEventListeners1() {
        ...
        $(".view-as-btn").on("click", function () {
            ...
            // Use the instance method to refetch events
        ...
        // --- FIX: Restore the "Enable Editing" button logic ---
        $('#toggle-edit-mode-btn').on('click', function () {
            ...
            if (currentMode === 'read') {
                ...
                showNotification('info', 'Drag & Drop is now enabled.', 3000);
            } else {
