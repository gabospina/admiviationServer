...
// And REPLACE it with this standardized version:
$userId = $_SESSION['HeliUser'] ?? 0;
echo '<script>
  var lastHeliSelected = "' . $lastHeliSelected . '";
  var pilotData = {
    user_id: ' . $userId . ', // Standardized to user_id
    firstName: "' . $firstName . '",
    lastName: "' . $lastName . '"
  };
</script>';
...
<div class="modal fade" id="futureScheduleModal" tabindex="-1" role="dialog" aria-labelledby="futureScheduleModalLabel">
    <div class="modal-dialog">
      ...
      <!-- //   ================== ABOVE - My Schedule - personal schedule in black boxes above Full Schedule gray boxes =================== -->
...
<div class="container">
    <div class="row outer-bottom-sm" style= "margin-top= 50px;" id="myScheduleSection">
        ...
        <table class="mysched table table-bordered text-center">
            <thead>
                <tr>
                    <th id="0"> <span class="date"></span><br><span class="day-name">Monday</span>
                    </th>
                    <th id="1"><span class="date"></span><br><span class="day-name">Tuesday</span>
                    </th>
                    <th id="2"><span class="date"></span><br><span class="day-name">Wednesday</span>
                    </th>
                    <th id="3"><span class="date"></span><br><span class="day-name">Thursday</span>
                    </th>
                    <th id="4"><span class="date"></span><br><span class="day-name">Friday</span>
                    </th>
                    <th id="5"><span class="date"></span><br><span class="day-name">Saturday</span>
                    </th>
                    <th id="6"><span class="date"></span><br><span class="day-name">Sunday</span>
                    </th>
                </tr>
            </thead>
            <tbody>
...
<div class="container">
            ...
            <div class="col-md-4 outer-bottom-xs">
                <div id="contractLegend">
                    <div style="display: flex; justify-content: space-between; align-items: flex-start;">
                        ...
                        <!-- A container for our two buttons -->
        ...
        <!-- MODIFICATION #4: Added a new wrapper for printing -->
...
<!-- Let Us Know Your Thoughts Section -->
    ...
    <div class="thoughts-panel">
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                ...
                <textarea id="thoughtsMessage" class="form-control" rows="5" style="resize: vertical;"></textarea>
            </div>
            <button class="btn btn-default" id="submitThoughts" style="width: 100%;">Send</button>
        </div>
    </div>
</div>

<!-- THE FIX: Added a new outer div with a margin-top class -->
