    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="changeCategoryModalLabel">ChangeP Document Category</h4>
            </div>
            <div class="modal-body">
                <!-- Form elements for changing the category -->
                <div class="form-group">
                    <label for="changeCategory">AssignP to Existing Category:</label>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">CancelP</button>
                <button type="button" class="btn btn-success" id="changeCategorySave">SaveP Changes</button>
            </div>
        </div>
    </div>
</div>